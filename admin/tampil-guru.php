...
<div class="container">
    <div class="row">
        ...
        <thead>
            <tr>
                ...
                <th>
                <a href="input-guru.php" class="btn btn-info">
    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-plus" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        include "../koneksi.php";
        $sql=$koneksi->query("select * from tb_guru order by nip ASC");
        ...
        ?>
             ...
             <tr>
                ...
                <a href="edit-guru.php?id=<?php echo $row['Id_guru']?>" class="btn btn-warning btn-sm">
...
<a href="hapus-guru.php?id=<?php echo $row['Id_guru']?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin menghapus data?')">
