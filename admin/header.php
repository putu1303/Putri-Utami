                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown ">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="tampil-siswa.php"> Direktori Siswa</a></li>
                            <li><a class="dropdown-item" href="tampil-guru.php"> Direktori Guru</a></li>
                        </ul>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link mx-2 bi bi-envelope-heart" href="contact.php">Contact</a>
                    </li>
                  
                </ul>
            </div>
            <div>
                <a href="../index.php"><button class="btn btn-info"> Logout</button></a>
